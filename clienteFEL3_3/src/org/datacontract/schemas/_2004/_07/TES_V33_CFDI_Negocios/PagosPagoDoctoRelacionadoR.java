...
public class PagosPagoDoctoRelacionadoR  implements java.io.Serializable {
    ...
    private java.lang.String metodoDePagoDR;
    ...
    private java.math.BigDecimal tipoCambioDR;
    ...
    /**
     * Gets the metodoDePagoDR value for this PagosPagoDoctoRelacionadoR.
     * 
     * @return metodoDePagoDR
     */
    public java.lang.String getMetodoDePagoDR() {
        return metodoDePagoDR;
    }


    /**
     * Sets the metodoDePagoDR value for this PagosPagoDoctoRelacionadoR.
     * 
     * @param metodoDePagoDR
     */
    public void setMetodoDePagoDR(java.lang.String metodoDePagoDR) {
        this.metodoDePagoDR = metodoDePagoDR;
    }
    ...
    /**
     * Gets the tipoCambioDR value for this PagosPagoDoctoRelacionadoR.
     * 
     * @return tipoCambioDR
     */
    public java.math.BigDecimal getTipoCambioDR() {
        return tipoCambioDR;
    }


    /**
     * Sets the tipoCambioDR value for this PagosPagoDoctoRelacionadoR.
     * 
     * @param tipoCambioDR
     */
    public void setTipoCambioDR(java.math.BigDecimal tipoCambioDR) {
        this.tipoCambioDR = tipoCambioDR;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.metodoDePagoDR==null && other.getMetodoDePagoDR()==null) || 
             (this.metodoDePagoDR!=null &&
              this.metodoDePagoDR.equals(other.getMetodoDePagoDR()))) &&
            ...
            ((this.tipoCambioDR==null && other.getTipoCambioDR()==null) || 
             (this.tipoCambioDR!=null &&
              this.tipoCambioDR.equals(other.getTipoCambioDR())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMetodoDePagoDR() != null) {
            _hashCode += getMetodoDePagoDR().hashCode();
        }
        if (getMonedaDR() != null) {
        ...
        if (getTipoCambioDR() != null) {
            _hashCode += getTipoCambioDR().hashCode();
        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/TES.V33.CFDI.Negocios", "PagosPagoDoctoRelacionadoR"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("metodoDePagoDR");
        elemField.setXmlName(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/TES.V33.CFDI.Negocios", "MetodoDePagoDR"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("tipoCambioDR");
        elemField.setXmlName(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/TES.V33.CFDI.Negocios", "TipoCambioDR"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "decimal"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
